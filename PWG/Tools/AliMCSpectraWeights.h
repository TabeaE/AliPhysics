...
private:
  ...
  fHistMCWeightsSys; /*!< Histograms for systematic variations of weight factors */
  TRandom3 frndGen;
...
public:
  ...
  float const GetMCSpectraWeight(Int_t mcGenParticle, Int_t SysCase=0); /*!< way to go; SysCase = 0 --> nominal; -1 --> sys. moved down; +1 --> sys. moved up */

  float const GetMCSpectraWeight(TParticle* mcGenParticle, Int_t SysCase=0); /*!< way to go; SysCase = 0 --> nominal; -1 --> sys. moved down; +1 --> sys. moved up */

  float const GetMCSpectraWeightNominal(Int_t mcGenParticle);/*!< main function to use. Will deliver correct weights to re-weight the abundances of different particle species */
  float const GetMCSpectraWeightNominal(TParticle* mcGenParticle);/*!< main function to use. Will deliver correct weights to re-weight the abundances of different particle species */
