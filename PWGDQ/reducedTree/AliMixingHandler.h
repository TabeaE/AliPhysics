...
private:
  ...
  Float_t fMixingThreshold;   // within a (centrality,vtx,ep) mix all pools with
                              // entries > fMixingThreshold*fPoolDepth
  ...
  void    RunEventMixing     (TClonesArray* leg1Pool, TClonesArray* leg2Pool, ULong_t mixingMask, Int_t type,
                              Float_t* values);
