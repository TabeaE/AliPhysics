...
const Char_t* AliReducedVarManager::fgkOfflineTriggerNames[64] = {
  "MB/INT1",                        "INT7",
  "MUON",                           "HighMult/HighMultSPD",
  "EMC1",                           "CINT5/INT5",
  "CMUS5/MUSPB/INT7inMUON",         "MuonSingleHighPt7/MUSH7/MUSHPB",
  "MuonLikeLowPt7/MUL7/MuonLikePB", "MuonUnlikeLowPt7/MUU7/MuonUnlikePB",
  "EMC7/EMC8",                      "MUS7/MuonSingleLowPt7",
  "PHI1",                           "PHI7/PHI8/PHOSPb",
  "EMCEJE",                         "EMCEGA",
  "Central/HighMultV0",             "SemiCentral",                        
  "DG/DG5",                         "ZED",
  "SPI7/SPI",                       "INT8",                               
  "MuonSingleLowPt8",               "MuonSingleHighPt8",
  "MuonLikeLowPt8",                 "MuonUnlikeLowPt8",                   
  "MuonUnlikeLowPt0/INT6",          "UserDefined",
  "TRD",                            "MuonCalo/CaloOnly",                  
  "FastOnly",                       "N/A",
  "N/A",                            "N/A",                                
  "N/A",                            "N/A",
  "N/A",                            "N/A",                                
...
AliReducedVarManager::AliReducedVarManager() : TObject()
{
  //
  // constructor
  //
...
//__________________________________________________________________
AliReducedVarManager::AliReducedVarManager(const Char_t* name) : TObject()
{
  //
  // named constructor
  //
...
void AliReducedVarManager::SetVariableDependencies() {
  ...
  if(fgUsedVars[kTPCnSigCorrected+kElectron] || fgUsedVars[kTPCnSigCorrected+kPion] ||
     fgUsedVars[kTPCnSigCorrected+kProton])
  {
...
//__________________________________________________________________
void AliReducedVarManager::FillEventInfo(BASEEVENT* baseEvent, Float_t* values,
                                         EVENTPLANE* eventF/*=0x0*/)
{
  //
  ...
  if(fgCurrentRunNumber != baseEvent->RunNo()) {
    ...
    if(fgRunTotalLuminosity)
      values[kTotalLuminosity] = fgRunTotalLuminosity->GetBinContent(
        fgRunTotalLuminosity->GetXaxis()->FindBin(Form("%d",fgCurrentRunNumber)));
    if(fgRunTotalIntensity0)
      values[kBeamIntensity0] = fgRunTotalIntensity0->GetBinContent(
        fgRunTotalIntensity0->GetXaxis()->FindBin(Form("%d",fgCurrentRunNumber)));
    if(fgRunTotalIntensity1)
      values[kBeamIntensity1] = fgRunTotalIntensity1->GetBinContent(
        fgRunTotalIntensity1->GetXaxis()->FindBin(Form("%d",fgCurrentRunNumber)));
    if(fgRunLHCFillNumber)
      values[kLHCFillNumber] = fgRunLHCFillNumber->GetBinContent(
        fgRunLHCFillNumber->GetXaxis()->FindBin(Form("%d",fgCurrentRunNumber)));
    if(fgRunDipolePolarity)
      values[kDipolePolarity] = fgRunDipolePolarity->GetBinContent(
        fgRunDipolePolarity->GetXaxis()->FindBin(Form("%d",fgCurrentRunNumber)));
    if(fgRunL3Polarity)
      values[kL3Polarity] = fgRunL3Polarity->GetBinContent(
        fgRunL3Polarity->GetXaxis()->FindBin(Form("%d",fgCurrentRunNumber)));
    if(fgRunTimeStart)
      values[kRunTimeStart] = fgRunTimeStart->GetBinContent(
        fgRunTimeStart->GetXaxis()->FindBin(Form("%d",fgCurrentRunNumber)));
    if(fgRunTimeEnd)
      values[kRunTimeEnd] = fgRunTimeEnd->GetBinContent(
        fgRunTimeEnd->GetXaxis()->FindBin(Form("%d",fgCurrentRunNumber)));
    if(fgGRPfile) {
    ...
    if(fgVZEROCalibrationPath.Data()[0] != '\0') {
      ...
      if(!calibList) {
         cout << "AliReducedVarManager::Info  Cannot open calibration file for run "
              << fgCurrentRunNumber << endl;
      ...
      if(fgOptionCalibrateVZEROqVec) {
        for(Int_t iCh=0; iCh<64; ++iCh) {
          fgAvgVZEROChannelMult[iCh] = (TProfile2D*)calibList->FindObject(
            Form("VZEROmult_ch%d_VtxCent_prof",iCh))->Clone(Form("run%d_ch%d",fgCurrentRunNumber,iCh));
          fgAvgVZEROChannelMult[iCh]->SetDirectory(0x0);
        }
      }
      if(fgOptionRecenterVZEROqVec) {
        fgVZEROqVecRecentering[0] = (TProfile2D*)calibList->FindObject(
          Form("QvecX_sideA_h2_CentSPDVtxZ_prof"))->Clone(
            Form("run%d_QvecX_VZEROA",fgCurrentRunNumber));
        fgVZEROqVecRecentering[0]->SetDirectory(0x0);
        fgVZEROqVecRecentering[1] = (TProfile2D*)calibList->FindObject(
          Form("QvecY_sideA_h2_CentSPDVtxZ_prof"))->Clone(
            Form("run%d_QvecY_VZEROA",fgCurrentRunNumber));
        fgVZEROqVecRecentering[1]->SetDirectory(0x0);
        fgVZEROqVecRecentering[2] = (TProfile2D*)calibList->FindObject(
          Form("QvecX_sideC_h2_CentSPDVtxZ_prof"))->Clone(
            Form("run%d_QvecX_VZEROC",fgCurrentRunNumber));
        fgVZEROqVecRecentering[2]->SetDirectory(0x0);
        fgVZEROqVecRecentering[3] = (TProfile2D*)calibList->FindObject(
          Form("QvecY_sideC_h2_CentSPDVtxZ_prof"))->Clone(
            Form("run%d_QvecY_VZEROC",fgCurrentRunNumber));
        fgVZEROqVecRecentering[3]->SetDirectory(0x0);
      }
      
      if(fgOptionRecenterTPCqVec) {
        fgTPCqVecRecentering[0] = (TProfile2D*)calibList->FindObject(
          Form("QvecX_TPC_h2_CentV0VtxZ_prof"))->Clone(Form("run%d_QvecX_TPC",fgCurrentRunNumber));
        fgTPCqVecRecentering[0]->SetDirectory(0x0);
        fgTPCqVecRecentering[1] = (TProfile2D*)calibList->FindObject(
          Form("QvecY_TPC_h2_CentV0VtxZ_prof"))->Clone(Form("run%d_QvecY_TPC",fgCurrentRunNumber));
    ...
    for(int iEstimator=0; iEstimator<kNMultiplicityEstimators; ++iEstimator) {
      if(fgAvgMultVsVtxAndRun[iEstimator]) {
        ...
        fgAvgMultVsVtxRunwise[iEstimator] = fgAvgMultVsVtxAndRun[iEstimator]->ProjectionY(
          Form("AvgMultVsVtxRunwise%d",iEstimator), fgRunID, fgRunID);
        if(fillGlobal) {
          fgAvgMultVsVtxGlobal[iEstimator] = fgAvgMultVsVtxAndRun[iEstimator]->ProjectionY(
            Form("AvgMultVsVtxGlobal%d",iEstimator));
          fgAvgMultVsVtxGlobal[iEstimator]->Scale(
            1./fgAvgMultVsVtxAndRun[iEstimator]->GetXaxis()->GetNbins());
          fgAvgMultVsRun[iEstimator] = fgAvgMultVsVtxAndRun[iEstimator]->ProjectionX(
            Form("AvgMultVsRun%d",iEstimator));
          fgAvgMultVsRun[iEstimator]->Scale(
            1./fgAvgMultVsVtxAndRun[iEstimator]->GetYaxis()->GetNbins());
        }
        for(int iReference=0; iReference<kNReferenceMultiplicities; ++iReference) {
          ...
          switch (iReference) {
            ...
            case kMeanMultiplicity :
              refVsVtx = 0.5 * (fgAvgMultVsVtxRunwise[iEstimator]->GetMaximum() +
                                fgAvgMultVsVtxRunwise[iEstimator]->GetMinimum());
              if(fillGlobal) {
                refVsVtxGlobal = 0.5 * (fgAvgMultVsVtxGlobal[iEstimator]->GetMaximum() + 
                                        fgAvgMultVsVtxGlobal[iEstimator]->GetMinimum());
                refVsRun       = 0.5 * (fgAvgMultVsRun[iEstimator]->GetMaximum() + 
                                        fgAvgMultVsRun[iEstimator]->GetMinimum());
                refVsVtxAndRun = 0.5 * (fgAvgMultVsVtxAndRun[iEstimator]->GetMaximum() + 
                                        fgAvgMultVsVtxAndRun[iEstimator]->GetMinimum());
              }
              break;
          }
  ...
  if(fgUsedVars[kDeltaVtxZMC])  values[kDeltaVtxZMC]  = values[kVtxZ] - values[kVtxZMC];
  ...
  if(TMath::Abs(values[kVZEROTotalMultFromChannels]) > 1.0e-6) {
    values[kVZEROTPCoutDiff] = (values[kVZEROTotalMultFromChannels]-values[kNTracksPerTrackingStatus+kTPCout]) /
                               (values[kVZEROTotalMultFromChannels]);
  } else {
    ...
    if(fgAvgMultVsVtxAndRun[iEstimator]) {
      ...
      for(Int_t iCorrection=0; iCorrection<kNCorrections; ++iCorrection) {
        for(Int_t iReference=0; iReference<kNReferenceMultiplicities; ++iReference ) {
          Int_t indexNotSmeared = GetCorrectedMultiplicity(estimator, iCorrection, iReference,
                                                           kNoSmearing);
          Int_t indexSmeared    = GetCorrectedMultiplicity(estimator, iCorrection, iReference,
                                                           kPoissonSmearing);
          ...
          // first apply vertex correction
            ...
            if(iCorrection == kVertexCorrectionGlobalGainLoss  ||
               iCorrection == kVertexCorrectionRunwiseGainLoss || iCorrection == kGainLossCorrection)
            {
          ...
          fgUsedVars[indexSmeared]    = kTRUE;
              ...
              (estimator==kSPDnTracklets10EtaVtxCorr &&
               fgAvgMultVsVtxAndRun[kSPDntrackletsEtaBin-kMultiplicity]))
    {
      for(Int_t iCorrection=0; iCorrection<kNCorrections; ++iCorrection) {
        for(Int_t iReference=0; iReference<kNReferenceMultiplicities; ++iReference) {
          Int_t indexNotSmeared = GetCorrectedMultiplicity(estimator, iCorrection, iReference, 
          ...
          if(estimator == kSPDnTracklets10EtaVtxCorr) {
            for(Int_t ieta=6; ieta<26; ++ieta) {
              ...
              if(fgAvgMultVsVtxGlobal[kSPDntrackletsEtaBin+ieta-kMultiplicity]->GetBinContent(vtxBin) > .3) {
                Int_t indexBinNotSmeared = GetCorrectedMultiplicity(kSPDntrackletsEtaBin+ieta, 
                                                                    iCorrection,
                                                                    iReference, kNoSmearing);
                Int_t indexBinSmeared    = GetCorrectedMultiplicity(kSPDntrackletsEtaBin+ieta, 
                                                                    iCorrection,
                                                                    iReference, kPoissonSmearing);
                if(fgUsedVars[indexBinNotSmeared])
                  values[indexNotSmeared] += values[indexBinNotSmeared];
                if(fgUsedVars[indexBinSmeared])
                  values[indexSmeared]    += values[indexBinSmeared];
              }
            }
          } else {
            Int_t indexAnotSmeared = GetCorrectedMultiplicity(kVZEROATotalMult, iCorrection, iReference,
                                                              kNoSmearing);
            Int_t indexCnotSmeared = GetCorrectedMultiplicity(kVZEROCTotalMult, iCorrection, iReference,
                                                              kNoSmearing);

            Int_t indexAsmeared = GetCorrectedMultiplicity(kVZEROATotalMult, iCorrection, iReference,
                                                           kPoissonSmearing);
            Int_t indexCsmeared = GetCorrectedMultiplicity(kVZEROCTotalMult, iCorrection, iReference,
                                                           kPoissonSmearing);
  ...
  if(values[kSPDntracklets] > 0.01) {
    values[kNTracksITSoutVsSPDtracklets] = values[kNTracksPerTrackingStatus+kITSout] /
                                           values[kSPDntracklets];
    values[kNTracksTPCoutVsSPDtracklets] = values[kNTracksPerTrackingStatus+kTPCout] /
                                           values[kSPDntracklets];
    values[kNTracksTRDoutVsSPDtracklets] = values[kNTracksPerTrackingStatus+kTRDout] /
                                           values[kSPDntracklets];
    values[kNTracksTOFoutVsSPDtracklets] = values[kNTracksPerTrackingStatus+kTOFout] /
                                           values[kSPDntracklets];
  } else {
  ...
  if(values[kVZEROTotalMult] > 1.0e-5) {
    values[kNTracksTPCoutVsVZEROTotalMult] = values[kNTracksPerTrackingStatus+kTPCout] /
                                             values[kVZEROTotalMult];
  } else {
  ...
  if(values[kVZEROTotalMultFromChannels] > 0.0) {
    values[kNTracksTPCoutFromPileup] = values[kNTracksTPCoutBeforeClean] -
      (-3.2+TMath::Sqrt(3.2*3.2+4.0*1.6e-5*values[kVZEROTotalMultFromChannels])) / (2.0*1.6e-5);
  }
  ...
  if(fgUsedVars[kNTPCclustersFromPileupRelative] && values[kNTPCclusters]>0.0)
    values[kNTPCclustersFromPileupRelative] = values[kNTPCclustersFromPileup] / 
                                              tpcClustersExpectationWOpileup;
  ...
  if(fgUsedVars[kVZEROQvecX+0*6+1] || fgUsedVars[kVZEROQvecY+0*6+1] || fgUsedVars[kVZERORP+0*6+1]) {
    ...
    if(fgOptionCalibrateVZEROqVec && fgAvgVZEROChannelMult[0]) {
      ...
      for(Int_t iCh=0; iCh<64; ++iCh) {
        if(event->MultChannelVZERO(iCh) >= fgkVZEROminMult) {
          Float_t avMult = fgAvgVZEROChannelMult[iCh]->GetBinContent(
            fgAvgVZEROChannelMult[iCh]->FindBin(event->Vertex(2),event->CentralitySPD()));
          Int_t refCh = iCh - (iCh%8);
          if(iCh == refCh) {
            refMult = fgAvgVZEROChannelMult[iCh]->GetBinContent(
              fgAvgVZEROChannelMult[iCh]->GetXaxis()->FindBin(0.0),
              fgAvgVZEROChannelMult[iCh]->GetYaxis()->FindBin(event->CentralitySPD()));
          }
          ...
          //  cout<<"V0 channel"<<" "<<iCh<<" "<<"Reference Channel "<<refCh<<" "<<
          //        "Reference multiplicity"<<refMult<<"Avg mult"<<avMult<<" "<<values[kVZEROChannelMult+iCh]<<
          //        " "<<values[kVZEROChannelMultCalib+iCh]<<endl;
        } else {
          fgUsedVars[kVZEROChannelMultCalib+iCh] = kFALSE;  // will not be filled in histograms by the
                                                            // histogram manager
        }
      }
    ...
    if(fgOptionRecenterVZEROqVec && fgVZEROqVecRecentering[0]) {
      Float_t recenterOffset = fgVZEROqVecRecentering[0]->GetBinContent(
        fgVZEROqVecRecentering[0]->FindBin(event->CentralitySPD(),event->Vertex(2)));
      Float_t widthEqVZERO = fgVZEROqVecRecentering[0]->GetBinError(
        fgVZEROqVecRecentering[0]->FindBin(event->CentralitySPD(),event->Vertex(2)));

      qvecVZEROA[1][0] -= recenterOffset;
      if(widthEqVZERO > 0.0) qvecVZEROA[1][0] /= widthEqVZERO;
      else                   qvecVZEROA[1][0]  = 0;

      recenterOffset = fgVZEROqVecRecentering[1]->GetBinContent(
                       fgVZEROqVecRecentering[1]->FindBin(event->CentralitySPD(),event->Vertex(2)));
      widthEqVZERO   = fgVZEROqVecRecentering[1]->GetBinError(
                       fgVZEROqVecRecentering[1]->FindBin(event->CentralitySPD(),event->Vertex(2)));
      qvecVZEROA[1][1] -= recenterOffset;
      if(widthEqVZERO > 0.0) qvecVZEROA[1][1] /= widthEqVZERO;
      else                   qvecVZEROA[1][1]  = 0;

      recenterOffset = fgVZEROqVecRecentering[2]->GetBinContent(
                       fgVZEROqVecRecentering[2]->FindBin(event->CentralitySPD(),event->Vertex(2)));
      widthEqVZERO   = fgVZEROqVecRecentering[2]->GetBinError(
                       fgVZEROqVecRecentering[2]->FindBin(event->CentralitySPD(),event->Vertex(2)));
      qvecVZEROC[1][0] -= recenterOffset;
      if(widthEqVZERO > 0.0) qvecVZEROC[1][0] /= widthEqVZERO;
      else                   qvecVZEROC[1][0]  = 0;

      recenterOffset = fgVZEROqVecRecentering[3]->GetBinContent(
                       fgVZEROqVecRecentering[3]->FindBin(event->CentralitySPD(),event->Vertex(2)));
      widthEqVZERO   = fgVZEROqVecRecentering[3]->GetBinError(
                       fgVZEROqVecRecentering[3]->FindBin(event->CentralitySPD(),event->Vertex(2)));
      qvecVZEROC[1][1] -= recenterOffset;
      if(widthEqVZERO > 0.0) qvecVZEROC[1][1] /= widthEqVZERO;
      else                   qvecVZEROC[1][1]  = 0;
    ...
    for(Int_t ih=1; ih<2; ++ih) {
      ...
      values[kVZEROQaQcSPsine+ih]  = TMath::Sin((ih+1)*
                                                (values[kVZERORP+0*6+ih]-values[kVZERORP+1*6+ih]));
      ...
      values[kVZEROQaQcSPsine+ih] *= TMath::Sqrt(values[kVZEROQvecX+1*6+ih]*values[kVZEROQvecX+1*6+ih]+
                                                 values[kVZEROQvecY+1*6+ih]*values[kVZEROQvecY+1*6+ih]);
      values[kVZERORP    +2*6+ih]  = TMath::ATan2(values[kVZEROQvecY+2*6+ih],
                                                  values[kVZEROQvecX+2*6+ih]) / Double_t(ih+1);
      // cos (n*(psi_A-psi_C))
  ...
  for(Int_t ih=0; ih<3; ++ih) {
    if(event->GetEventPlaneStatus(EVENTPLANE::kTPC,ih+1) != EVENTPLANE::kUnset) {
      ...
      if(fgOptionRecenterTPCqVec && fgTPCqVecRecentering[0] && ih==1) {
        Float_t recenterOffsetTPC = fgTPCqVecRecentering[0]->GetBinContent(
          fgTPCqVecRecentering[0]->FindBin(event->CentralityVZERO(),event->Vertex(2)));
        Double_t widthEqTPC = fgTPCqVecRecentering[0]->GetBinError(
          fgTPCqVecRecentering[0]->FindBin(event->CentralityVZERO(),event->Vertex(2)));
        values[kTPCQvecXtree+1] -= recenterOffsetTPC;

        if(widthEqTPC > 0.0) values[kTPCQvecXtree+1] /= widthEqTPC;
        else                 values[kTPCQvecXtree+1]  = 0;

        recenterOffsetTPC = fgTPCqVecRecentering[1]->GetBinContent(
          fgTPCqVecRecentering[1]->FindBin(event->CentralityVZERO(),event->Vertex(2)));
        widthEqTPC = fgTPCqVecRecentering[1]->GetBinError(
          fgTPCqVecRecentering[1]->FindBin(event->CentralityVZERO(),event->Vertex(2)));
        values[kTPCQvecYtree+1] -= recenterOffsetTPC;

        if(widthEqTPC > 0.0) values[kTPCQvecYtree+1] /= widthEqTPC;
        else                 values[kTPCQvecYtree+1]  = 0;

        values[kTPCRPtree+ih] = TMath::ATan2(values[kTPCQvecYtree+1],values[kTPCQvecXtree+1]) /
                                Double_t(ih+1);
      }
    }
    ...
    if(fgOptionEventRes &&
      (fgUsedVars[kVZEROARPres+ih]||fgUsedVars[kVZEROCRPres+ih]||fgUsedVars[kVZEROTPCRPres+ih]))
    {
      if(values[kTPCRPres+1*6+ih]>1.0e-7 && values[kTPCRPres+0*6+ih]>1.0e-7 && values[kVZERORPres+ih]>1.0e-7) {
        values[kVZEROARPres+ih]   = TMath::Sqrt(values[kTPCRPres+1*6+ih]/
                                               (values[kVZERORPres+ih]*values[kTPCRPres+0*6+ih]));
        values[kVZEROCRPres+ih]   = TMath::Sqrt(values[kTPCRPres+0*6+ih]/
                                               (values[kVZERORPres+ih]*values[kTPCRPres+1*6+ih]));
        values[kVZEROTPCRPres+ih] = TMath::Sqrt(values[kVZERORPres+ih]/
                                               (values[kTPCRPres+0*6+ih]*values[kTPCRPres+1*6+ih]));
      } else {
  ...
  if(eventF) {
    for(Int_t ih=0; ih<6; ++ih) {
      ...
      for(Int_t iVZEROside=0; iVZEROside<2; ++iVZEROside) {
        ...
        // cos(n(EPtpc-EPvzero A/C))
        if(fgUsedVars[kTPCRPres+iVZEROside*6+ih]) {
          values[kTPCRPres+iVZEROside*6+ih] = DeltaPhi(
            eventF->EventPlane(EVENTPLANE::kTPC,ih+1),
            eventF->EventPlane(EVENTPLANE::kVZEROA+iVZEROside,ih+1));
          values[kTPCRPres+iVZEROside*6+ih] = TMath::Cos(values[kTPCRPres+iVZEROside*6+ih]*(ih+1));
        }
      }
...
void AliReducedVarManager::FillITSsharedLayerFlag(TRACK* track, Int_t layer, Float_t* values) {
   ...
   if(fgUsedVars[kITSlayerShared] && track->ITSLayerHit(layer) && track->ITSClusterIsShared(layer))
     values[kITSlayerShared] = layer+1;
}
...
void AliReducedVarManager::FillMCTruthInfo(TRACK* p, Float_t* values, TRACK* leg1/*=0x0*/, TRACK* leg2/*=0x0*/)
{
  ...
  if(fgUsedVars[kPtMCfromLegs]  || fgUsedVars[kPMCfromLegs]   || fgUsedVars[kPxMCfromLegs]    ||
     ...
     fgUsedVars[kEtaMCfromLegs] || fgUsedVars[kPhiMCfromLegs] || fgUsedVars[kMassMCfromLegs]  ||
     fgUsedVars[kRapMCfromLegs] || fgUsedVars[kPairLegPtMC]   || fgUsedVars[kPairLegPtMC+1]   ||
     fgUsedVars[kPairLegPtMCSum])
...
void AliReducedVarManager::FillTrackInfo(BASETRACK* p, Float_t* values) {
  ...
  for(Int_t iVZEROside=0; iVZEROside<3; ++iVZEROside) {
    for(Int_t ih=0; ih<6; ++ih) {
      if(fgUsedVars[kVZEROFlowVn+iVZEROside*6+ih]) {
        values[kVZEROFlowVn+iVZEROside*6+ih] = TMath::Cos((values[kPhi]-values[kVZERORP+iVZEROside*6+ih]) *
                                                          (ih+1));
      }
      ...
      if(fgUsedVars[kVZERODeltaPhiPsiN+iVZEROside*6+ih]) {
        ...
        values[kVZERODeltaPhiPsiN+iVZEROside*6+ih] -= 2.0 * TMath::Pi() / Double_t(ih+1) *
          TMath::Floor(Double_t(ih+1)/2.0/TMath::Pi()*values[kVZERODeltaPhiPsiN+iVZEROside*6+ih]);
        // transform to [0; pi/n]
      ...
      if(iVZEROside<2) {
        if(fgUsedVars[kVZEROuQ+iVZEROside*6+ih]) {
          values[kVZEROuQ+iVZEROside*6+ih]  = TMath::Cos((values[kPhi]-values[kVZERORP+iVZEROside*6+ih]) *
                                                         (ih+1));
        ...
        if(fgUsedVars[kVZEROuQsine+iVZEROside*6+ih]) {
          values[kVZEROuQsine+iVZEROside*6+ih] = TMath::Sin((values[kPhi]-values[kVZERORP+iVZEROside*6+ih]) *
                                                            (ih+1));
  ...
  if(tpcEPUsed) {
    ...
    for(Int_t ih=0; ih<6; ++ih) {
      ...
      if(fgUsedVars[kTPCDeltaPhiPsiN+ih]) {
        ...
        // transform to the interval [0; 2*pi/n]
        values[kTPCDeltaPhiPsiN+ih] -= 2.0 * TMath::Pi() / Double_t(ih+1) *
                                       TMath::Floor(Double_t(ih+1)/2.0/TMath::Pi()*values[kTPCDeltaPhiPsiN+ih]);
        // transform to [0; pi/n]
      ...
      if(fgUsedVars[kTPCuQ+ih]) {
        ...
        values[kTPCuQ+ih] *= TMath::Sqrt(values[kVZEROQvecX+ih]*values[kVZEROQvecX+ih] +
                                         values[kVZEROQvecY+ih]*values[kVZEROQvecY+ih]);
      }
      if(fgUsedVars[kTPCuQsine+ih]) {
        values[kTPCuQsine+ih]  = TMath::Sin((values[kPhi]-values[kTPCRPtree+ih])*(ih+1));
        values[kTPCuQsine+ih] *= TMath::Sqrt(values[kVZEROQvecX+ih]*values[kVZEROQvecX+ih] +
                                             values[kVZEROQvecY+ih]*values[kVZEROQvecY+ih]);
      }
    }
  }
  ...
  if(fgUsedVars[kTPCnclsRatio3]) {
    values[kTPCnclsRatio3] = (pinfo->TPCFindableNcls()>0
                              ? Float_t(pinfo->TPCCrossedRows())/Float_t(pinfo->TPCFindableNcls())
                              : 0.0);
  }
...
//_________________________________________________________________
void AliReducedVarManager::FillClusterMatchedTrackInfo(AliReducedBaseTrack* p, Float_t* values,
  TList* clusterList/*=0x0*/, AliReducedCaloClusterTrackMatcher* matcher/*=0x0*/)
{
  //
  ...
  if(!fgUsedVars[kEMCALmatchedEnergy] && !fgUsedVars[kEMCALmatchedEOverP] &&
     !fgUsedVars[kEMCALmatchedM02]    && !fgUsedVars[kEMCALmatchedM20]    &&
  ...
  if(fgEvent && (fgEvent->IsA()==EVENT::Class())) {
    ...
    if(fgUsedVars[kEMCALmatchedClusterId])
      values[kEMCALmatchedClusterId]      = (cluster ? pinfo->CaloClusterId()    : -9999.);
    if(fgUsedVars[kEMCALmatchedEnergy])
      values[kEMCALmatchedEnergy]         = (cluster ? cluster->Energy()         : -9999.);
    if(fgUsedVars[kEMCALmatchedM02])
      values[kEMCALmatchedM02]            = (cluster ? cluster->M02()            : -9999.);
    if(fgUsedVars[kEMCALmatchedM20])
      values[kEMCALmatchedM20]            = (cluster ? cluster->M20()            : -9999.);
    if(fgUsedVars[kEMCALmatchedNCells])
      values[kEMCALmatchedNCells]         = (cluster ? cluster->NCells()         : -9999.);
    if(fgUsedVars[kEMCALmatchedNMatchedTracks])
      values[kEMCALmatchedNMatchedTracks] = (cluster ? cluster->NMatchedTracks() : -9999.);
    if(fgUsedVars[kEMCALmatchedNSigmaElectron])
      values[kEMCALmatchedNSigmaElectron] = (cluster ? pinfo->EMCALnSigEle()     : -9999.);
...
void AliReducedVarManager::FillPairInfo(BASETRACK* t1, BASETRACK* t2, Int_t type, Float_t* values) {
  ...
  if(fgUsedVars[kMass]) {     
    ...
    if(values[kMass] < 0.0) {
      ...
      cout << "p1(p,x,y,z): " << t1->P() << ", " << t1->Px() << ", " << t1->Py() << ", " << t1->Pz()
           << endl;
      cout << "p2(p,x,y,z): " << t2->P() << ", " << t2->Px() << ", " << t2->Py() << ", " << t2->Pz()
           << endl;
      values[kMass] = 0.0;
    }
    else
  ...
  if(fgUsedVars[kDMA] && (t1->IsA()==TRACK::Class()) && (t2->IsA()==TRACK::Class())) {
    TRACK* ti1 = (TRACK*)t1;
    TRACK* ti2 = (TRACK*)t2;
    values[kDMA] = TMath::Sqrt((ti1->HelixX()-ti2->HelixX())*(ti1->HelixX()-ti2->HelixX())+
                               (ti1->HelixY()-ti2->HelixY())*(ti1->HelixY()-ti2->HelixY())) -
                                ti1->HelixR()-ti2->HelixR();
  }
  
  if((fgUsedVars[kPairLegTPCchi2] || fgUsedVars[kPairLegTPCchi2+1]) && (t1->IsA()==TRACK::Class()) &&
     (t2->IsA()==TRACK::Class())) {
     TRACK* ti1 = (TRACK*)t1;
     TRACK* ti2 = (TRACK*)t2;
  ...
  if((fgUsedVars[kPairLegITSchi2] || fgUsedVars[kPairLegITSchi2+1]) && (t1->IsA()==TRACK::Class()) &&
     (t2->IsA()==TRACK::Class())) {
    TRACK* ti1 = (TRACK*)t1;
    TRACK* ti2 = (TRACK*)t2;
  ...
  if((t1->IsA()==TRACK::Class()) && (t2->IsA()==TRACK::Class()) && (fgEvent->IsA()==EVENT::Class())) {
    TRACK* ti1 = (TRACK*)t1;
    TRACK* ti2 = (TRACK*)t2;
    ...
    if(pairKF.GetNDF()) values[kPairChi2prNDOF] = pairKF.GetChi2()/pairKF.GetNDF();
    else                values[kPairChi2prNDOF] = -999.;
    ...
    if(fgUsedVars[kPseudoProperDecayTime]) {
      ...
      if(errPseudoProperTime2 >= 0.)
        values[kPseudoProperDecayTimeError]    = TMath::Sqrt(errPseudoProperTime2);
      if(errPseudoProperTimeXYZ2 >= 0.)
        values[kPseudoProperDecayTimeXYZError] = TMath::Sqrt(errPseudoProperTimeXYZ2);
    }
    ...
    Double_t deltaPrimSecVtx2   = deltaPrimSecVtx[0]*deltaPrimSecVtx[0] +
    ...
    values[kPairLxyz] = (deltaPrimSecVtx[0]*p.Px()+deltaPrimSecVtx[1]*p.Py()+deltaPrimSecVtx[2]*p.Pz()) /
                        TMath::Sqrt(momV02);
  ...
  if(p.PairType() == 1) {
    ...
    if(pinfo1 && pinfo2 && !pinfo1->IsMCTruth() && !pinfo2->IsMCTruth()) {
      pMC.PxPyPz(pinfo1->MCmom(0)+pinfo2->MCmom(0), pinfo1->MCmom(1)+pinfo2->MCmom(1),
    ...
    if(fgUsedVars[kPairEff_weight]) {
      if(pinfo1 && pinfo2 && !pinfo1->IsMCTruth() && !pinfo2->IsMCTruth()) {
        if(fgUsePinForLegEffPropagation == kTRUE) {
          values[kPairEffDown_weight] = GetPairEffWeightFactor(values[kCentVZERO], pinfo1->Pin(),
                                                        pinfo2->Pin(), pinfo1->Eta(), pinfo2->Eta(), 0);
          values[kPairEff_weight]     = GetPairEffWeightFactor(values[kCentVZERO], pinfo1->Pin(),
                                                        pinfo2->Pin(), pinfo1->Eta(), pinfo2->Eta(), 1);
          values[kPairEffUp_weight]   = GetPairEffWeightFactor(values[kCentVZERO], pinfo1->Pin(),
                                                        pinfo2->Pin(), pinfo1->Eta(), pinfo2->Eta(), 2);
        } else {
          values[kPairEffDown_weight] = GetPairEffWeightFactor(values[kCentVZERO], pinfo1->P(), 
                                                        pinfo2->P(), pinfo1->Eta(), pinfo2->Eta(), 0);
          values[kPairEff_weight]     = GetPairEffWeightFactor(values[kCentVZERO], pinfo1->P(),       
                                                        pinfo2->P(), pinfo1->Eta(), pinfo2->Eta(), 1);
          values[kPairEffUp_weight]   = GetPairEffWeightFactor(values[kCentVZERO], pinfo1->P(), 
                                                        pinfo2->P(), pinfo1->Eta(), pinfo2->Eta(), 2);
        }
      } else {
    ...
    if(fgUsedVars[kMassMC]) {
      if(pinfo1 && pinfo2 && !pinfo1->IsMCTruth() && !pinfo2->IsMCTruth()) {
        values[kMassMC] = m1*m1 + m2*m2 +
          2.0 * (TMath::Sqrt(m1*m1+pinfo1->PMC()*pinfo1->PMC())*
                 TMath::Sqrt(m2*m2+pinfo2->PMC()*pinfo2->PMC()) -
      ...
      if(values[kMassMC] < 0.0) {
        cout << "FillPairInfo(track, track, type, values): Warning: Very small squared mass found. "
             << "   Could be negative due to resolution of Float_t so it will be set to a small "
                "positive value." << endl;
  ...
  if(t1->IsA()==TRACK::Class() && t2->IsA()==TRACK::Class()) {
    ...
    if(fgUsedVars[kPairDca])
      values[kPairDca]   = TMath::Sqrt(ti1->DCAxy()*ti1->DCAxy() + ti2->DCAxy()*ti2->DCAxy() +
                                       ti1->DCAz() *ti1->DCAz()  + ti2->DCAz() *ti2->DCAz());
    if(fgUsedVars[kPairDcaXY])
      values[kPairDcaXY] = TMath::Sqrt(ti1->DCAxy()*ti1->DCAxy() + ti2->DCAxy()*ti2->DCAxy());
    if(fgUsedVars[kPairDcaZ])
      values[kPairDcaZ]  = TMath::Sqrt(ti1->DCAz() *ti1->DCAz()  + ti2->DCAz() *ti2->DCAz());

    if(fgUsedVars[kPairDcaSqrt])
      values[kPairDcaSqrt]   = TMath::Power(ti1->DCAxy()*ti1->DCAxy()+ti2->DCAxy()*ti2->DCAxy() +
                                            ti1->DCAz() *ti1->DCAz() +ti2->DCAz() *ti2->DCAz(), 0.25);
    if(fgUsedVars[kPairDcaXYSqrt])
      values[kPairDcaXYSqrt] = TMath::Power(ti1->DCAxy()*ti1->DCAxy()+ti2->DCAxy()*ti2->DCAxy(), 0.25);
    if(fgUsedVars[kPairDcaZSqrt])
      values[kPairDcaZSqrt]  = TMath::Power(ti1->DCAz()*ti1->DCAz()  +ti2->DCAz()*ti2->DCAz(), 0.25);
    ...
    if(fgUsedVars[kOpAngDcaPtCorr]) {
      ...
      values[kOpAngDcaPtCorr] = values[kPairOpeningAngle] - a - b*values[kPairDcaXYSqrt] - 
                                c*values[kOneOverSqrtPt] -
                                d*values[kPairDcaXYSqrt]*values[kOneOverSqrtPt];
    }
    if(fgUsedVars[kMassDcaPtCorr]) {
      ...
      values[kMassDcaPtCorr] = values[kMass] - a - b*values[kPairDcaXYSqrt] - c*values[kPt] - 
                               d*values[kPairDcaXYSqrt]*values[kPt];
    }
  }
}
...
void AliReducedVarManager::FillPairMEflow(BASETRACK* t1, BASETRACK* t2, Float_t* values/*, Int_t idx/*=0*/) {
  ...
  if(fgUsedVars[kPairVZEROFlowSPNom+0*6+1] || fgUsedVars[kPairVZEROFlowSPDenom+0*6+1]) {
    values[kPairVZEROFlowSPNom+0*6+1] = TMath::Cos(2.0*(t1->Phi()-values[kPhi])) *
      (TMath::Cos(2.0*t1->Phi())*track1->CovMatrix(0)+TMath::Sin(2.0*t1->Phi())*track1->CovMatrix(1));
    values[kPairVZEROFlowSPNom+0*6+1] += TMath::Cos(2.0*(t2->Phi()-values[kPhi])) *
  ...
  if(fgUsedVars[kPairVZEROFlowSPNom+1*6+1] || fgUsedVars[kPairVZEROFlowSPDenom+1*6+1]) {
    values[kPairVZEROFlowSPNom+1*6+1] = TMath::Cos(2.0*(t1->Phi()-values[kPhi])) *
      (TMath::Cos(2.0*t1->Phi())*track1->CovMatrix(2)+TMath::Sin(2.0*t1->Phi())*track1->CovMatrix(3));
    values[kPairVZEROFlowSPNom+1*6+1] += TMath::Cos(2.0*(t2->Phi()-values[kPhi])) *
  ...
  if(fgUsedVars[kPairTPCFlowSPNom+1] || fgUsedVars[kPairTPCFlowSPDenom+1]) {
    values[kPairTPCFlowSPNom+1] = TMath::Cos(2.0*(t1->Phi()-values[kPhi])) *
      (TMath::Cos(2.0*t1->Phi())*track1->CovMatrix(4)+TMath::Sin(2.0*t1->Phi())*track1->CovMatrix(5));
    values[kPairTPCFlowSPNom+1] += TMath::Cos(2.0*(t2->Phi()-values[kPhi])) *
                                            ...
                                            Float_t* values)
{
  ...
  if(fgUsedVars[kTriggerRap] && (trig->IsA()==PAIR::Class()))
    values[kTriggerRap] = ((PAIR*)trig)->Rapidity();
  if(fgUsedVars[kTriggerRapAbs] && (trig->IsA()==PAIR::Class()))
    values[kTriggerRapAbs] = TMath::Abs(((PAIR*)trig)->Rapidity());
...
// fill info on B candidate (Jpsi+K) by idstoreh
  ...
  if(fgUsedVars[kMassJpsiK]) {
    values[kMassJpsiK] = ((PAIR*)trig)->Mass()*((PAIR*)trig)->Mass() +
      fgkParticleMass[kKaon]*fgkParticleMass[kKaon] +
      2.0 * (TMath::Sqrt(((PAIR*)trig)->Mass()*((PAIR*)trig)->Mass()+((PAIR*)trig)->P()*((PAIR*)trig)->P())*
             TMath::Sqrt(fgkParticleMass[kKaon]*fgkParticleMass[kKaon]+assoc->P()*assoc->P())-
  ...
  Double_t doubletAssocDistance  = 0;
  Double_t doubletAssocDeviation = 0;
  AliKFParticle tripletKF = BuildKFtriplet(eleg1, fgkParticleMass[kElectron], eleg2, fgkParticleMass[kElectron],
                                           kassoc, fgkParticleMass[kKaon], doubletAssocDistance,
                                           doubletAssocDeviation);
  ...
  if(tripletKF.GetNDF()) values[kTripletChi2prNDOF] = tripletKF.GetChi2()/tripletKF.GetNDF();
  else                   values[kTripletChi2prNDOF] = -999.;

  Double_t errPseudoProperTime3;
  if(fgUsedVars[kTripletPseudoProperDecayTime]) {
    values[kTripletPseudoProperDecayTime] = tripletKF.GetPseudoProperDecayTime(primVtx,
      fgkPairMass[AliReducedPairInfo::kBToJpsiK], &errPseudoProperTime3);
  }
  ...
  Double_t deltaPrimTripletVtx2 = deltaPrimTripletVtx[0]*deltaPrimTripletVtx[0] +
                                  deltaPrimTripletVtx[1]*deltaPrimTripletVtx[1] +
                                  deltaPrimTripletVtx[2]*deltaPrimTripletVtx[2];
  Double_t momb2 = bCandVec.Px()*bCandVec.Px() + bCandVec.Py()*bCandVec.Py() + bCandVec.Pz()*bCandVec.Pz();

  values[kTripletLxy]  = (deltaPrimTripletVtx[0]*bCandVec.Px()+deltaPrimTripletVtx[1]*bCandVec.Py()) /
                         bCandVec.Pt();
  values[kTripletLxyz] = (deltaPrimTripletVtx[0]*bCandVec.Px() + deltaPrimTripletVtx[1]*bCandVec.Py() +
                          deltaPrimTripletVtx[2]*bCandVec.Pz()) / TMath::Sqrt(momb2);
...
void AliReducedVarManager::FillCorrelationInfo(BASETRACK* trig, BASETRACK* assoc, Float_t* values) {
  ...
  // NOTE:  Add here only NEEDED information because this function is called during event mixing
  ...
  if(fgUsedVars[kTriggerRapAbs] && (trig->IsA()==PAIR::Class()))
    values[kTriggerRapAbs] = TMath::Abs(((PAIR*)trig)->Rapidity());
  if(fgUsedVars[kTriggerPseudoProperDecayTime] && (trig->IsA()==PAIR::Class()))
    values[kTriggerPseudoProperDecayTime] = ((PAIR*)trig)->PsProper();
  if(fgUsedVars[kTriggerPairTypeSPD] && (trig->IsA()==PAIR::Class()))
    values[kTriggerPairTypeSPD] = ((PAIR*)trig)->PairTypeSPD();
  ...
  if(trig->IsA()==PAIR::Class() && (fgUsedVars[kAssociatedPtOverTriggerGammaT] || fgUsedVars[kTriggerGammaT])) {
  ...
  if(trig->IsA()==PAIR::Class() &&
    (fgUsedVars[kDeltaPhiBoosted] || fgUsedVars[kDeltaPhiSymBoosted] || fgUsedVars[kDeltaThetaBoosted] ||
     fgUsedVars[kDeltaEtaBoosted] || fgUsedVars[kDeltaEtaAbsBoosted] || fgUsedVars[kAssociatedPtBoosted] ||
     fgUsedVars[kAssociatedEtaBoosted] || fgUsedVars[kAssociatedPhiBoosted]))
  {
    // get boost vector
    TLorentzVector trigVec;
  ...
  Float_t leg1Mass/*=gkParticleMass[kElectron]*/, Float_t leg2Mass/*=gkParticleMass[kElectron]*/)
{
  ...
  //
  if(!leg1 || !leg2) {
    cout<<"AliReducedVarManager::GetThetaPhiCM:  base leg doesn't exist"<<endl;
    return;
  }
  Double_t pxyz1[3] = {leg1->Px(),leg1->Py(),leg1->Pz()};
  Double_t pxyz2[3] = {leg2->Px(),leg2->Py(),leg2->Pz()};
    
  TLorentzVector projMom(0., 0., -fgBeamMomentum,
    TMath::Sqrt(fgBeamMomentum*fgBeamMomentum+fgkParticleMass[kProton]*fgkParticleMass[kProton]));
  TLorentzVector targMom(0., 0., fgBeamMomentum,
    TMath::Sqrt(fgBeamMomentum*fgBeamMomentum+fgkParticleMass[kProton]*fgkParticleMass[kProton]));
...
void AliReducedVarManager::SetDefaultVarNames() {
  ...
  fgVariableNames[kNumberOfDetectors] = "Nof active detectors"; fgVariableUnits[kNumberOfDetectors] = "";
  ...
  fgVariableNames[kTimeRelativeSORfraction] = "Event time from SOR";
  fgVariableUnits[kTimeRelativeSORfraction] = "fraction of total run duration";
  ...
  fgVariableNames[kIsSPDPileupMultBins] = "SPD pileup multiplicity bins ON";
  fgVariableUnits[kIsSPDPileupMultBins] = "";
  fgVariableNames[kNSPDpileups]         = "Nof SPD pileup events";   fgVariableUnits[kNSPDpileups]   = "";
  fgVariableNames[kNTrackPileups]       = "Nof track pileup events"; fgVariableUnits[kNTrackPileups] = "";
  fgVariableNames[kIRIntClosestIntMap]  = "Closest out of bunch int. IRInt1";
  fgVariableUnits[kIRIntClosestIntMap]  = "";
  fgVariableNames[kIRIntClosestIntMap+1] = "Closest out of bunch int. IRInt2";
  fgVariableUnits[kIRIntClosestIntMap+1] = "";
  fgVariableNames[kNPMDtracks]           = "Nof PMD tracks";       fgVariableUnits[kNPMDtracks]       = "";
  fgVariableNames[kNTRDtracks]           = "Nof TRD tracks";       fgVariableUnits[kNTRDtracks]       = "";
  fgVariableNames[kNTRDtracklets]        = "Nof TRD tracklets";    fgVariableUnits[kNTRDtracklets]    = "";
  fgVariableNames[kNVtxContributors]     = "Nof vtx contributors"; fgVariableUnits[kNVtxContributors] = "";
  fgVariableNames[kNVtxTPCContributors]  = "Nof TPC vtx contributors";
  fgVariableUnits[kNVtxTPCContributors]  = "";
  fgVariableNames[kNVtxSPDContributors]  = "Nof SPD vtx contributors";
  fgVariableUnits[kNVtxSPDContributors]  = "";
  ...
  fgVariableNames[kVtxXMC]               = "Vtx X MC";             fgVariableUnits[kVtxX]        = "cm";
  fgVariableNames[kVtxYMC]               = "Vtx Y MC";             fgVariableUnits[kVtxY]        = "cm";
  fgVariableNames[kVtxZMC]               = "Vtx Z MC";             fgVariableUnits[kVtxZ]        = "cm";
  fgVariableNames[kDeltaVtxZMC]          = "#Delta Z (global-MC)"; fgVariableUnits[kDeltaVtxZMC] = "cm";
  ...
  fgVariableNames[kTPCpileupContributorsAC] = "TPC pileup n-contributors from A&C sides";
  fgVariableUnits[kTPCpileupContributorsAC] = "";
  fgVariableNames[kTPCpileupContributorsA]  = "TPC pileup n-contributors from A side";
  fgVariableUnits[kTPCpileupContributorsA]  = "";
  fgVariableNames[kTPCpileupContributorsC]  = "TPC pileup n-contributors from C side";
  fgVariableUnits[kTPCpileupContributorsC]  = "";
  ...
  fgVariableNames[kTPCpileupContributorsAC2] = "TPC pileup n-contributors (2) from A&C sides";
  fgVariableUnits[kTPCpileupContributorsAC2] = "";
  fgVariableNames[kTPCpileupContributorsA2]  = "TPC pileup n-contributors (2) from A side";
  fgVariableUnits[kTPCpileupContributorsA2]  = "";
  fgVariableNames[kTPCpileupContributorsC2]  = "TPC pileup n-contributors (2) from C side";
  fgVariableUnits[kTPCpileupContributorsC2]  = "";
  ...
  fgVariableNames[kNTracksTPCoutBeforeClean] = "Nof kTPCout before ESD cleanup";
  fgVariableUnits[kNTracksTPCoutBeforeClean] = "";
  ...
  fgVariableNames[kNTracksITSoutVsSPDtracklets] = "ITSout/SPDtracklets";
  fgVariableUnits[kNTracksITSoutVsSPDtracklets] = "";
  fgVariableNames[kNTracksTPCoutVsSPDtracklets] = "TPCout/SPDtracklets";
  fgVariableUnits[kNTracksTPCoutVsSPDtracklets] = "";
  fgVariableNames[kNTracksTRDoutVsSPDtracklets] = "TRDout/SPDtracklets";
  fgVariableUnits[kNTracksTRDoutVsSPDtracklets] = "";
  fgVariableNames[kNTracksTOFoutVsSPDtracklets] = "TOFout/SPDtracklets";
  fgVariableUnits[kNTracksTOFoutVsSPDtracklets] = "";
  fgVariableNames[kNTracksTPCoutFromPileup]     = "# kTPCout tracks - expectation";
  fgVariableUnits[kNTracksTPCoutFromPileup]     = "";
  fgVariableNames[kNTracksTPCoutVsVZEROTotalMult] = "TPCout / VZERO multiplicity";
  fgVariableUnits[kNTracksTPCoutVsVZEROTotalMult] = "";
  ...
  fgVariableNames[kNV0total]            = "Total nof V0s";            fgVariableUnits[kNV0total]         = "";
  fgVariableNames[kNV0selected]         = "Nof selected V0s";         fgVariableUnits[kNV0selected]      = "";
  fgVariableNames[kNpairsSelected]      = "Nof pairs per event";      fgVariableUnits[kNpairsSelected]   = "";
  fgVariableNames[kEvAverageTPCchi2]    = "Event TPC <chi2>";         fgVariableUnits[kEvAverageTPCchi2] = "";
  fgVariableNames[kNDplusToK0sPiplusSelected]     = "Nof D+ ->K0s pi+ pairs per event";
  fgVariableUnits[kNDplusToK0sPiplusSelected]     = "";
  fgVariableNames[kNDplusToK0sKplusSelected]      = "Nof D+ ->K0s K+ pairs per event";
  fgVariableUnits[kNDplusToK0sKplusSelected]      = "";
  fgVariableNames[kNDplusToPhiPiplusSelected]     = "Nof D+ ->phi pi+ pairs per event";
  fgVariableUnits[kNDplusToPhiPiplusSelected]     = "";
  fgVariableNames[kNDminusToK0sPiminusSelected]   = "Nof D- ->K0s pi- pairs per event";
  fgVariableUnits[kNDminusToK0sPiminusSelected]   = "";
  fgVariableNames[kNDminusToK0sKminusSelected]    = "Nof D- ->K0s K- pairs per event";
  fgVariableUnits[kNDminusToK0sKminusSelected]    = "";
  fgVariableNames[kNDminusToPhiPiminusSelected]   = "Nof D- ->phi pi- pairs per event";
  fgVariableUnits[kNDminusToPhiPiminusSelected]   = "";
  fgVariableNames[kNDzeroToKminusPiplusSelected]  = "Nof D0 ->K- pi+ pairs per event";
  fgVariableUnits[kNDzeroToKminusPiplusSelected]  = "";
  fgVariableNames[kNADzeroToKplusPiminusSelected] = "Nof anti-D0 ->K+ pi- pairs per event";
  fgVariableUnits[kNADzeroToKplusPiminusSelected] = "";
  fgVariableNames[kNDsplusToK0sKplusSelected]     = "Nof Ds+ ->K0s K+ pairs per event";
  fgVariableUnits[kNDsplusToK0sKplusSelected]     = "";
  fgVariableNames[kNDsminusToK0sKminusSelected]   = "Nof Ds- ->K0s K- pairs per event";
  fgVariableUnits[kNDsminusToK0sKminusSelected]   = "";
  fgVariableNames[kNtracksTotal]  = "Nof tracks in original event"; fgVariableUnits[kNtracksTotal]    = "";
  fgVariableNames[kNtracksSelected]        = "Nof selected tracks"; fgVariableUnits[kNtracksSelected] = "";
  fgVariableNames[kNtracks1Selected]       = "Nof selected tracks (electrons)";
  fgVariableUnits[kNtracks1Selected]       = "";
  fgVariableNames[kNtracks2Selected]       = "Nof selected tracks (not electrons)";
  fgVariableUnits[kNtracks2Selected]       = "";
  fgVariableNames[kNtracksPosAnalyzed]     = "Nof selected positive tracks";
  fgVariableUnits[kNtracksPosAnalyzed]     = "";
  fgVariableNames[kNtracksNegAnalyzed]     = "Nof selected negative tracks";
  fgVariableUnits[kNtracksNegAnalyzed]     = "";
  fgVariableNames[kNtracksPiPlusAnalyzed]  = "Nof selected pos. pions";
  fgVariableUnits[kNtracksPiPlusAnalyzed]  = "";
  fgVariableNames[kNtracksPiMinusAnalyzed] = "Nof selected neg. pions";
  fgVariableUnits[kNtracksPiMinusAnalyzed] = "";
  fgVariableNames[kNtracksKPlusAnalyzed]   = "Nof selected pos. kaons";
  fgVariableUnits[kNtracksKPlusAnalyzed]   = "";
  fgVariableNames[kNtracksKMinusAnalyzed]  = "Nof selected neg. kaons";
  fgVariableUnits[kNtracksKMinusAnalyzed]  = "";
  fgVariableNames[kNK0sAnalyzed]        = "Nof selected K0s candidates"; fgVariableUnits[kNK0sAnalyzed]    = "";
  fgVariableNames[kNPhiAnalyzed]        = "Nof selected phi candidates"; fgVariableUnits[kNPhiAnalyzed]    = "";
  fgVariableNames[kNtracksAnalyzed]     = "Nof selected tracks";         fgVariableUnits[kNtracksAnalyzed] = "";
  for(Int_t i=0; i<18; ++i)
    fgVariableNames[kNtracksAnalyzedInPhiBins+i] = Form("# selected tracks in #varphi sector %d and #eta<0.", i);
  for(Int_t i=0; i<18; ++i)
    fgVariableNames[kNtracksAnalyzedInPhiBins+18+i] = Form("# selected tracks in #varphi sector %d and #eta>0.", i);
  fgVariableNames[kNtracksSubEvLeft]  = "Nof tracks sub-event left";  fgVariableUnits[kNtracksSubEvLeft]  = "";
  fgVariableNames[kNtracksSubEvRight] = "Nof tracks sub-event right"; fgVariableUnits[kNtracksSubEvRight] = "";
  fgVariableNames[kNtracksEventPlane] = "Nof tracks event plane";     fgVariableUnits[kNtracksEventPlane] = "";
  fgVariableNames[kNCaloClusters]     = "Nof calorimeter clusters";   fgVariableUnits[kNCaloClusters] = "";
  fgVariableNames[kNTPCclusters]           = "TPC clusters";          fgVariableUnits[kNTPCclusters]  = "";
  fgVariableNames[kNTPCclustersFromPileup] = "TPC clusters above expectation w/o pileup";
  fgVariableUnits[kNTPCclustersFromPileup] = "";
  fgVariableNames[kNTPCclustersFromPileupRelative] = "Relative nof TPC clusters above expectation w/o pileup";
  fgVariableUnits[kNTPCclustersFromPileupRelative] = "";
  
  TString multEstimators[kNMultiplicityEstimators] = {
    "SPD tracklets (|#eta|<1.0)",
    "SPDntracklets08",
    "SPDntracklets16",
    ...
    "SPDntrackletsVtxEta",
    "N_{trk} (|#eta|<0.9)",
    "N_{trk} (|#eta|<0.9) (cutset 2)",
    "N_{trk} (|#eta|<0.9) (cutset 3)",
    "N_{trk} (|#eta|<0.9) (cutset 4)",
    "N_{trk} (|#eta|<0.9) (cutset 5)",
    "N_{trk} (|#eta|<0.9) (cutset 6)",
    "N_{trk} (|#eta|<0.9) (cutset 7)",
    "N_{trk} (|#eta|<0.9) (cutset 8)",
    "Global Tracks toward (|#eta|<0.9)",
    "Global Tracks toward (|#eta|<0.9) (cutset 2)",
    "Global Tracks toward (|#eta|<0.9) (cutset 3)",
    "Global Tracks toward (|#eta|<0.9) (cutset 4)",
    "Global Tracks toward (|#eta|<0.9) (cutset 5)",
    "Global Tracks toward (|#eta|<0.9) (cutset 6)",
    "Global Tracks toward (|#eta|<0.9) (cutset 7)",
    "Global Tracks toward (|#eta|<0.9) (cutset 8)",
    "Global Tracks toward (to leading pt) in |#eta|<0.9",
    "Global Tracks toward (to leading pt) in |#eta|<0.9 (cutset 2)",
    "Global Tracks toward (to leading pt) in |#eta|<0.9 (cutset 3)",
    "Global Tracks toward (to leading pt) in |#eta|<0.9 (cutset 4)",
    "Global Tracks toward (to leading pt) in |#eta|<0.9 (cutset 5)",
    "Global Tracks toward (to leading pt) in |#eta|<0.9 (cutset 6)",
    "Global Tracks toward (to leading pt) in |#eta|<0.9 (cutset 7)",
    "Global Tracks toward (to leading pt) in |#eta|<0.9 (cutset 8)",
    ...
    "Global Tracks transverse (to leading pt) in |#eta|<0.9",
    "Global Tracks transverse (to leading pt) in |#eta|<0.9 (cutset 2)",
    "Global Tracks transverse (to leading pt) in |#eta|<0.9 (cutset 3)",
    "Global Tracks transverse (to leading pt) in |#eta|<0.9 (cutset 4)",
    "Global Tracks transverse (to leading pt) in |#eta|<0.9 (cutset 5)",
    "Global Tracks transverse (to leading pt) in |#eta|<0.9 (cutset 6)",
    "Global Tracks transverse (to leading pt) in |#eta|<0.9 (cutset 7)",
    "Global Tracks transverse (to leading pt) in |#eta|<0.9 (cutset 8)",
    ...
    "Global Tracks away in |#eta|<0.9",
    "Global Tracks away (to leading pt) in |#eta|<0.9 (cutset 2)",
    "Global Tracks away (to leading pt) in |#eta|<0.9 (cutset 3)",
    "Global Tracks away (to leading pt) in |#eta|<0.9 (cutset 4)",
    "Global Tracks away (to leading pt) in |#eta|<0.9 (cutset 5)",
    "Global Tracks away (to leading pt) in |#eta|<0.9 (cutset 6)",
    "Global Tracks away (to leading pt) in |#eta|<0.9 (cutset 7)",
    "Global Tracks away (to leading pt) in |#eta|<0.9 (cutset 8)",
    "VZEROTotalMult",
    "VZEROATotalMult",
    "VZEROCTotalMult",
  ...
  fgVariableNames[kVZEROATotalMultFromChannels] = "VZERO-A total multiplicity";
  fgVariableUnits[kVZEROATotalMultFromChannels] = "";
  fgVariableNames[kVZEROCTotalMultFromChannels] = "VZERO-C total multiplicity";
  fgVariableUnits[kVZEROCTotalMultFromChannels] = "";
  fgVariableNames[kVZEROTotalMultFromChannels]  = "VZERO total multiplicity";
  fgVariableUnits[kVZEROTotalMultFromChannels]  = "";
  ...
  for(Int_t il=0; il<6; ++il) {
    fgVariableNames[kITSnClusters+il] = Form("ITS clusters (layer %d)", il+1); 
    fgVariableUnits[kITSnClusters+il] = "";
  }
  fgVariableNames[kSPDnSingleClusters]           = "SPD single clusters";
  fgVariableUnits[kSPDnSingleClusters]           = "";
  fgVariableNames[kSDDandSSDclusters]            = "SDD+SSD clusters";
  fgVariableUnits[kSDDandSSDclusters]            = "";
  fgVariableNames[kEventMixingId]                = "Event mixing id";
  fgVariableUnits[kEventMixingId]                = "";
  fgVariableNames[kVZEROCurrentChannel]          = "VZERO channel";
  fgVariableUnits[kVZEROCurrentChannel]          = "";
  fgVariableNames[kVZEROCurrentChannelMult]      = "VZERO channel multiplicity";
  fgVariableUnits[kVZEROCurrentChannelMult]      = "";
  fgVariableNames[kVZEROCurrentChannelMultCalib] = "VZERO channel calibrated multiplicity";
  fgVariableUnits[kVZEROCurrentChannelMultCalib] = "";
  fgVariableNames[kVZEROAemptyChannels]          = "VZERO-A empty channels";
  fgVariableUnits[kVZEROAemptyChannels]          = "";
  fgVariableNames[kVZEROCemptyChannels]          = "VZERO-C empty channels";
  fgVariableUnits[kVZEROCemptyChannels]          = "";
  for(Int_t ich=0; ich<64; ++ich) {
  ...
  for(Int_t i=0; i<3; ++i) {
    fgVariableUnits[kTZEROTOF+i]     = "ps";
    fgVariableUnits[kTZEROTOFbest+i] = "ps";
  }
  ...
  fgVariableNames[kINT7Triggered]           = "event was triggered with INT7";
  fgVariableUnits[kINT7Triggered]           = "";
  fgVariableNames[kCentralTriggered]        = "event was triggered with Central trigger";
  fgVariableUnits[kCentralTriggered]        = "";
  fgVariableNames[kSemiCentralTriggered]    = "event was triggered with Semi-Central trigger";
  fgVariableUnits[kSemiCentralTriggered]    = "";
  fgVariableNames[kINT7orCentTriggered]     = "event was triggered with INT7 or Central trigger";
  fgVariableUnits[kINT7orCentTriggered]     = "";
  fgVariableNames[kINT7orSemiCentTriggered] = "event was triggered with INT7 or Semi-Central trigger";
  fgVariableUnits[kINT7orSemiCentTriggered] = "";
  fgVariableNames[kTRDTriggeredType]        = "event was triggered by TRD ele trigger";
  fgVariableUnits[kTRDTriggeredType]        = "";
  fgVariableNames[kHighMultV0Triggered]     = "event was triggered with HighMultV0";
  fgVariableUnits[kHighMultV0Triggered]     = "";
  fgVariableNames[kEMCEGATriggered]         = "event was triggered with EMCEGA";
  fgVariableUnits[kEMCEGATriggered]         = "";
  fgVariableNames[kEMCEGAHighTriggered]     = "event was triggered with EMCEGA high thresh.";
  fgVariableUnits[kEMCEGAHighTriggered]     = "";

  TString vzeroSideNames[3] = {"A", "C", "AC"};
  for(Int_t iHarmonic=0; iHarmonic<6; ++iHarmonic) {
    for(Int_t iSide=0; iSide<3; ++iSide) {
      fgVariableNames[kVZEROQvecX+iSide*6+iHarmonic]        = Form("Q_{x,%d}^{VZERO-%s}",
                                                                   iHarmonic+1,vzeroSideNames[iSide].Data());
      fgVariableUnits[kVZEROQvecX+iSide*6+iHarmonic]        = "";
      fgVariableNames[kVZEROQvecY+iSide*6+iHarmonic]        = Form("Q_{y,%d}^{VZERO-%s}",
                                                                   iHarmonic+1,vzeroSideNames[iSide].Data());
      fgVariableUnits[kVZEROQvecY  +iSide*6+iHarmonic]      = "";
      fgVariableNames[kVZEROQvecMag+iSide*6+iHarmonic]      = Form("|Q_{%d}^{VZERO-%s}|",
                                                                   iHarmonic+1,vzeroSideNames[iSide].Data());
      fgVariableUnits[kVZEROQvecMag+iSide*6+iHarmonic]      = "";
      fgVariableNames[kVZERORP     +iSide*6+iHarmonic]      = Form("#Psi_{%d}^{VZERO-%s}",
                                                                   iHarmonic+1,vzeroSideNames[iSide].Data());
      fgVariableUnits[kVZERORP     +iSide*6+iHarmonic]      = "rad";
      fgVariableNames[kVZEROFlowVn +iSide*6+iHarmonic]      = Form("v_{%d}{EP,VZERO-%s}",
                                                                   iHarmonic+1,vzeroSideNames[iSide].Data());
      fgVariableUnits[kVZEROFlowVn      +iSide*6+iHarmonic] = "";
      fgVariableNames[kVZERODeltaPhiPsiN+iSide*6+iHarmonic] = Form("#phi-#Psi_{%d}{VZERO-%s}",
                                                                   iHarmonic+1,vzeroSideNames[iSide].Data());
      ...
      if(iSide < 2) {
        fgVariableNames[kVZEROuQ    +iSide*6+iHarmonic] = Form("cos(%d(#phi - #Psi_{%d}^{VZERO-%s})|Q^{VZERO-%s}_{%d}|",iHarmonic+1,iHarmonic+1,vzeroSideNames[iSide].Data(),vzeroSideNames[iSide].Data(),iHarmonic+1);
        fgVariableUnits[kVZEROuQ    +iSide*6+iHarmonic] = "";
        fgVariableNames[kVZEROuQsine+iSide*6+iHarmonic] = Form("sin(%d(#phi - #Psi_{%d}^{VZERO-%s})|Q^{VZERO-%s}_{%d}|",iHarmonic+1,iHarmonic+1,vzeroSideNames[iSide].Data(),vzeroSideNames[iSide].Data(),iHarmonic+1);
        fgVariableUnits[kVZEROuQsine+iSide*6+iHarmonic] = "";
      }
    }
    fgVariableNames[kVZERORPres +iHarmonic] = Form("#sqrt{%d(#Psi_{%d}^{VZERO-A}-#Psi_{%d}^{VZERO-C})}",iHarmonic+1,iHarmonic+1,iHarmonic+1);
    fgVariableUnits[kVZERORPres +iHarmonic] = "rad^{1/2}";
    fgVariableNames[kVZEROARPres+iHarmonic] = Form("#sqrt{cos(%d(#Psi_{%d}^{VZERO-C}-#Psi_{%d}^{TPC}))/cos(%d(#Psi_{%d}^{VZERO-A}-#Psi_{%d}^{VZERO-C}))*cos(%d(#Psi_{%d}^{VZERO-A}-#Psi_{%d}^{TPC}))}",iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1);
    fgVariableUnits[kVZEROARPres+iHarmonic] = "rad^{1/2}";
    fgVariableNames[kVZEROCRPres+iHarmonic] = Form("#sqrt{cos(%d(#Psi_{%d}^{VZERO-A}-#Psi_{%d}^{TPC}))/cos(%d(#Psi_{%d}^{VZERO-A}-#Psi_{%d}^{VZERO-C}))*cos(%d(#Psi_{%d}^{VZERO-C}-#Psi_{%d}^{TPC}))}",iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1);
    ...
    fgVariableNames[kVZEROQaQcSP+iHarmonic]     = Form("cos(%d(#Psi_{%d}^{VZERO-A} - #Psi_{%d}^{VZERO-C})|Q^{VZERO-A}_{%d}||Q^{VZERO-C}_{%d}|",iHarmonic+1, iHarmonic+1, iHarmonic+1, iHarmonic+1, iHarmonic+1);
    fgVariableUnits[kVZEROQaQcSP+iHarmonic]     = "";
    fgVariableNames[kVZEROQaQcSPsine+iHarmonic] = Form("sin(%d(#Psi_{%d}^{VZERO-A} - #Psi_{%d}^{VZERO-C})|Q^{VZERO-A}_{%d}||Q^{VZERO-C}_{%d}|",iHarmonic+1, iHarmonic+1, iHarmonic+1, iHarmonic+1, iHarmonic+1);
    ...
    fgVariableNames[kTPCRPres+iHarmonic] = Form("#sqrt{%d(#Psi_{%d}^{TPC}-#Psi_{%d}^{VZERO-A})}", iHarmonic+1, iHarmonic+1, iHarmonic+1);
    fgVariableUnits[kTPCRPres+iHarmonic] = "rad^{1/2}";
    fgVariableNames[kVZEROTPCRPres+6+iHarmonic] = Form("#sqrt{cos(%d(#Psi_{%d}^{VZERO-A}-#Psi_{%d}^{VZERO-C}))/cos(%d(#Psi_{%d}^{VZERO-A}-#Psi_{%d}^{TPC}))*cos(%d(#Psi_{%d}^{VZERO-A}-#Psi_{%d}^{TPC}))}",iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1,iHarmonic+1);
    ...
    fgVariableNames[kTPCsubResCos+iHarmonic]  = Form("cos(%d(#Psi_{%d}^{TPC,left}-#Psi_{%d}^{TPC,right}))", iHarmonic+1, iHarmonic+1, iHarmonic+1);
    ...
    fgVariableNames[kTPCFlowSine+iHarmonic]           = Form("sin(%d(#varphi-#Psi_{%d}^{TPC}))",
                                                             iHarmonic+1, iHarmonic+1);
    fgVariableUnits[kTPCFlowSine+iHarmonic]           = "";
    fgVariableNames[kTPCuQ+iHarmonic]                 = Form("cos(%d(#phi - #Psi_{%d}^{TPC})|Q^{TPC}_{%d}|",
                                                             iHarmonic+1,iHarmonic+1,iHarmonic+1);
    fgVariableUnits[kTPCuQ+iHarmonic]                 = "";
    fgVariableNames[kTPCuQsine+iHarmonic]             = Form("sin(%d(#phi - #Psi_{%d}^{TPC})|Q^{TPC}_{%d}|",
                                                             iHarmonic+1,iHarmonic+1,iHarmonic+1);
  ...
  fgVariableNames[kMCNch09Transverse] = "N_{ch} Transverse (|#eta|<0.9)"; fgVariableUnits[kMCNch09+2]   = "";
  fgVariableNames[kMCNch09Away]       = "N_{ch} Away (|#eta|<0.9)";       fgVariableUnits[kMCNch09+2]   = "";
  fgVariableNames[kMCNchSPDacc]       = "N_{ch} in SPD acceptance";       fgVariableUnits[kMCNchSPDacc] = "";
  fgVariableNames[kEtaBinForSPDtracklets]      = "#eta";
  fgVariableUnits[kEtaBinForSPDtracklets]      = "";
  fgVariableNames[kMCNchNegSide]               = "N_{ch} (-1<#eta<0)";
  fgVariableUnits[kMCNchNegSide]               = "";
  fgVariableNames[kMCNchPosSide]               = "N_{ch} (0<#eta<1)";
  fgVariableUnits[kMCNchPosSide]               = "";
  fgVariableNames[kDiffNchSPDtrklts]           = "N_{ch} (|#eta|<1) - SPD #trklts";
  fgVariableUnits[kDiffNchSPDtrklts]           = "";
  fgVariableNames[kDiffNchSPDaccSPDtrklts]     = "N_{ch}^{SPD} - SPD #trklts";
  fgVariableUnits[kDiffNchSPDaccSPDtrklts]     = "";
  fgVariableNames[kRelDiffNchSPDtrklts]        = "(N_{ch} (|#eta|<1) - SPD #trklts) / N_{ch} (|#eta|<1)";
  fgVariableUnits[kRelDiffNchSPDtrklts]        = "";
  fgVariableNames[kRelDiffNchSPDaccSPDtrklts]  = "(N_{ch}^{SPD} - SPD #trklts) / N_{ch}^{SPD}";
  fgVariableUnits[kRelDiffNchSPDaccSPDtrklts]  = "";
  fgVariableNames[kRelDiff2NchSPDtrklts] = "2*(N_{ch}(|#eta|<1)-SPD #trklts) / (N_{ch}(|#eta|<1)+SPD #trklts)";
  fgVariableUnits[kRelDiff2NchSPDtrklts] = "";
  fgVariableNames[kRelDiff2NchSPDaccSPDtrklts] = "2*(N_{ch}^{SPD}-SPD #trklts) / (N_{ch}^{SPD}+SPD #trklts)";
  fgVariableUnits[kRelDiff2NchSPDaccSPDtrklts] = "";
  ...
  for(Int_t iHarmonic=0; iHarmonic<6; ++iHarmonic) {
    fgVariableNames[kCosNPhi+iHarmonic] = Form("cos(%d#varphi)",iHarmonic+1);
    fgVariableUnits[kCosNPhi+iHarmonic] = "";
    fgVariableNames[kSinNPhi+iHarmonic] = Form("sin(%d#varphi)",iHarmonic+1);
    fgVariableUnits[kSinNPhi+iHarmonic] = "";
  }
  fgVariableNames[kPtSquared]       = "p_{T}^{2}";
  fgVariableUnits[kPtSquared]       = "GeV^{2}/c^{2}";
  ...
  fgVariableNames[kPdgMC]           = "PDG code";
  fgVariableUnits[kPdgMC]           = "";
  fgVariableNames[kPdgMC+1]         = "mother's PDG code";
  fgVariableUnits[kPdgMC+1]         = "";
  fgVariableNames[kPdgMC+2]         = "grand-mother's PDG code";
  fgVariableUnits[kPdgMC+2]         = "";
  fgVariableNames[kPdgMC+3]         = "grand-grand-mother's PDG code";
  fgVariableUnits[kPdgMC+3]         = "";
  fgVariableNames[kPCCWeight]       = "PCC weight;";
  fgVariableUnits[kPCCWeight]       = "";
  ...
  fgVariableNames[kMassV0]          = "m_{K^{0}_{S}}";
  fgVariableUnits[kMassV0]          = "GeV/c^{2}";
  fgVariableNames[kMassV0+1]        = "m_{#Lambda^{0}}";
  fgVariableUnits[kMassV0+1]        = "GeV/c^{2}";
  fgVariableNames[kMassV0+2]        = "m_{#bar{#Lambda^{0}}}";
  fgVariableUnits[kMassV0+2]        = "GeV/c^{2}";
  fgVariableNames[kMassV0+3]        = "m_{#gamma}";
  fgVariableUnits[kMassV0+3]        = "GeV/c^{2}";
  ...
  fgVariableNames[kPseudoProperDecayTime]         = "t";
  fgVariableUnits[kPseudoProperDecayTime]         = "cm/c";
  fgVariableNames[kPseudoProperDecayTimeError]    = "t err";
  fgVariableUnits[kPseudoProperDecayTimeError]    = "cm/c";
  fgVariableNames[kPseudoProperDecayTimeMC]       = "t_{MC}";
  fgVariableUnits[kPseudoProperDecayTimeMC]       = "cm/c";
  fgVariableNames[kPseudoProperDecayTimeXYZ]      = "t_{xyz}";
  fgVariableUnits[kPseudoProperDecayTimeXYZ]      = "cm/c";
  fgVariableNames[kPseudoProperDecayTimeXYZError] = "t_{xyz} err";
  fgVariableUnits[kPseudoProperDecayTimeXYZError] = "cm/c";
  fgVariableNames[kPairOpeningAngle]       = "pair opening angle";
  fgVariableUnits[kPairOpeningAngle]       = "rad";
  fgVariableNames[kPairPointingAngle]      = "#theta_{pointing}";
  fgVariableUnits[kPairPointingAngle]      = "rad";
  fgVariableNames[kPairCosPointingAngle]   = "cos(#theta_{pointing})";
  fgVariableUnits[kPairCosPointingAngle]   = "";
  fgVariableNames[kPairCosPointingAngleXY] = "cos(#theta_{pointing xy})";
  fgVariableUnits[kPairCosPointingAngleXY] = "";
  fgVariableNames[kPairDCAXY]        = "DCA_{xy,pair KFParticle}"; fgVariableUnits[kPairDCAXY] = "cm";
  fgVariableNames[kPairDCAZ]         = "DCA_{z,pair KFParticle}";  fgVariableUnits[kPairDCAZ]  = "cm";
  ...
  for(Int_t i=0;i<2;++i) {
    ...
    fgVariableUnits[kPairLegPt+i]                 = "GeV/c";
    fgVariableUnits[kPairLegPtMC+i]               = "GeV/c";
  ...
  fgVariableNames[kPairLegPtSum]   = "Pair leg p_{T,1} + p_{T,2}";
  fgVariableUnits[kPairLegPtSum]   = "GeV/c";
  fgVariableNames[kPairLegPtMCSum] = "Pair leg p^{MC}_{T,1} + p^{MC}_{T,2}";
  fgVariableUnits[kPairLegPtMCSum] = "GeV/c";
  ...
  fgVariableNames[kPairDcaXYSqrt]  = "DCA^{1/2}_{xy,pair}";
  fgVariableUnits[kPairDcaXYSqrt]  = "cm^{1/2}";
  fgVariableNames[kPairDcaZSqrt]   = "DCA^{1/2}_{z,pair}";
  fgVariableUnits[kPairDcaZSqrt]   = "cm^{1/2}";
  fgVariableNames[kMassDcaPtCorr]  = "DCA-, p_{T}-corrected mass";
  fgVariableUnits[kMassDcaPtCorr]  = "GeV/c^{2}";
  fgVariableNames[kOpAngDcaPtCorr] = "DCA-, p_{T}-corrected opening angle";
  fgVariableUnits[kOpAngDcaPtCorr] = "rad";
  fgVariableNames[kTrackLength]    = "Track length";
  fgVariableUnits[kTrackLength]    = "cm";
  fgVariableNames[kChi2TPCConstrainedVsGlobal] = "#chi^{2} TPC constrained vs global";
  fgVariableUnits[kChi2TPCConstrainedVsGlobal] = "";
  fgVariableNames[kMassUsedForTracking] = "Mass used for tracking";
  fgVariableUnits[kMassUsedForTracking] = "GeV/c^{2}";
  fgVariableNames[kITSncls]             = "Nof ITS clusters";
  fgVariableUnits[kITSncls]             = "";
  fgVariableNames[kITSchi2]             = "ITS #chi^{2}";
  fgVariableUnits[kITSchi2]             = "";
  fgVariableNames[kITSnclsShared]       = "Nof shared ITS clusters";
  fgVariableUnits[kITSnclsShared]       = "";
  fgVariableNames[kNclsSFracITS]        = "Fraction of shared ITS clusters/ITS clusters";
  fgVariableUnits[kNclsSFracITS]        = "";
  fgVariableNames[kITSlayerHit]         = "ITS layer";
  fgVariableUnits[kITSlayerHit]         = "";
  fgVariableNames[kITSlayerShared]      = "ITS layer";
  fgVariableUnits[kITSlayerShared]      = "";
  fgVariableNames[kITSsignal]           = "ITS dE/dx";
  fgVariableUnits[kITSsignal]           = "";
  fgVariableNames[kITSnSig]             = "ITS n_{#sigma}^{e}";
  fgVariableUnits[kITSnSig]             = "#sigma";
  fgVariableNames[kITSnSig+1]           = "ITS n_{#sigma}^{#pi}";
  fgVariableUnits[kITSnSig+1]           = "#sigma";
  fgVariableNames[kITSnSig+2]           = "ITS n_{#sigma}^{K}";
  fgVariableUnits[kITSnSig+2]           = "#sigma";
  fgVariableNames[kITSnSig+3]           = "ITS n_{#sigma}^{p}";
  fgVariableUnits[kITSnSig+3]           = "#sigma";
  fgVariableNames[kTPCncls]             = "Nof TPC clusters";
  fgVariableUnits[kTPCncls]             = "";
  fgVariableNames[kTPCchi2]             = "TPC #chi^{2}";
  fgVariableUnits[kTPCchi2]             = "";
  fgVariableNames[kTPCclusBitFired]     = "TPC segment";
  fgVariableUnits[kTPCclusBitFired]     = "";
  fgVariableNames[kTPCNclusBitsFired]   = "Nof TPC segments";
  fgVariableUnits[kTPCNclusBitsFired]   = "";
  fgVariableNames[kTPCclustersPerBit]   = "Nof TPC clusters/segment";
  fgVariableUnits[kTPCclustersPerBit]   = "";
  fgVariableNames[kTPCcrossedRows]      = "Nof TPC crossed rows";
  fgVariableUnits[kTPCcrossedRows]      = "";
  fgVariableNames[kTPCnclsF]            = "Nof TPC findable clusters";
  fgVariableUnits[kTPCnclsF]            = "";
  fgVariableNames[kTPCnclsShared]       = "Nof TPC shared clusters";
  fgVariableUnits[kTPCnclsShared]       = "";
  fgVariableNames[kTPCnclsSharedRatio]  = "# TPC shared clusters / all TPC clusters";
  fgVariableUnits[kTPCnclsSharedRatio]  = "fraction";
  fgVariableNames[kTPCnclsRatio]        = "Nof TPC clusters/findable";
  fgVariableUnits[kTPCnclsRatio]        = "";
  fgVariableNames[kTPCnclsRatio2]       = "Nof TPC clusters/crossed rows";
  fgVariableUnits[kTPCnclsRatio2]       = "";
  fgVariableNames[kTPCcrossedRowsOverFindableClusters] = "Crossed rows / findable clusters";
  fgVariableUnits[kTPCcrossedRowsOverFindableClusters] = "";
  fgVariableNames[kTPCnclsRatio3]   = "Nof TPC crossed rows/findable clusters";
  fgVariableUnits[kTPCnclsRatio3]   = "";
  fgVariableNames[kTPCActiveLength] = "Track length in active TPC";
  fgVariableUnits[kTPCActiveLength] = "";
  fgVariableNames[kTPCGeomLength]   = "Track relative geometric length in active TPC";
  fgVariableUnits[kTPCGeomLength]   = "";
  fgVariableNames[kTPCsignal]       = "TPC dE/dx";
  fgVariableUnits[kTPCsignal]       = "";
  fgVariableNames[kTPCsignalN]      = "Nof TPC clusters PID";
  fgVariableUnits[kTPCsignalN]      = "";
  fgVariableNames[kTPCdEdxQmax+0]   = "TPC dE/dx Qmax from IROC";
  fgVariableUnits[kTPCdEdxQmax+0]   = "";
  fgVariableNames[kTPCdEdxQmax+1]   = "TPC dE/dx Qmax from medium OROC";
  fgVariableUnits[kTPCdEdxQmax+1]   = "";
  fgVariableNames[kTPCdEdxQmax+2]   = "TPC dE/dx Qmax from long OROC";
  fgVariableUnits[kTPCdEdxQmax+2]   = "";
  fgVariableNames[kTPCdEdxQmax+3]   = "TPC dE/dx Qmax from all OROC";
  fgVariableUnits[kTPCdEdxQmax+3]   = "";
  fgVariableNames[kTPCdEdxQtot+0]   = "TPC dE/dx Qtot from IROC";
  fgVariableUnits[kTPCdEdxQtot+0]   = "";
  fgVariableNames[kTPCdEdxQtot+1]   = "TPC dE/dx Qtot from medium OROC";
  fgVariableUnits[kTPCdEdxQtot+1]   = "";
  fgVariableNames[kTPCdEdxQtot+2]   = "TPC dE/dx Qtot from long OROC";
  fgVariableUnits[kTPCdEdxQtot+2]   = "";
  fgVariableNames[kTPCdEdxQtot+3]   = "TPC dE/dx Qtot from all OROC";
  fgVariableUnits[kTPCdEdxQtot+3]   = "";
  fgVariableNames[kTPCdEdxQmaxOverQtot+0] = "TPC dE/dx Qmax/Qtot from IROC";
  fgVariableUnits[kTPCdEdxQmaxOverQtot+0] = "";
  fgVariableNames[kTPCdEdxQmaxOverQtot+1] = "TPC dE/dx Qmax/Qtot from medium OROC";
  fgVariableUnits[kTPCdEdxQmaxOverQtot+1] = "";
  fgVariableNames[kTPCdEdxQmaxOverQtot+2] = "TPC dE/dx Qmax/Qtot from long OROC";
  fgVariableUnits[kTPCdEdxQmaxOverQtot+2] = "";
  fgVariableNames[kTPCdEdxQmaxOverQtot+3] = "TPC dE/dx Qmax/Qtot from all OROC";
  fgVariableUnits[kTPCdEdxQmaxOverQtot+3] = "";
  fgVariableNames[kTPCnSig]            = "TPC n_{#sigma}^{e}";
  fgVariableUnits[kTPCnSig]            = "#sigma";
  fgVariableNames[kTPCnSig+1]          = "TPC n_{#sigma}^{#pi}";
  fgVariableUnits[kTPCnSig+1]          = "#sigma";
  fgVariableNames[kTPCnSig+2]          = "TPC n_{#sigma}^{K}";
  fgVariableUnits[kTPCnSig+2]          = "#sigma";
  fgVariableNames[kTPCnSig+3]          = "TPC n_{#sigma}^{p}";
  fgVariableUnits[kTPCnSig+3]          = "#sigma";
  fgVariableNames[kTPCnSigCorrected]   = "TPC n_{#sigma}^{e} - corrected";
  fgVariableUnits[kTPCnSigCorrected]   = "#sigma";
  fgVariableNames[kTPCnSigCorrected+1] = "TPC n_{#sigma}^{#pi} - corrected";
  fgVariableUnits[kTPCnSigCorrected+1] = "#sigma";
  fgVariableNames[kTPCnSigCorrected+2] = "TPC n_{#sigma}^{K} - corrected";
  fgVariableUnits[kTPCnSigCorrected+2] = "#sigma";
  fgVariableNames[kTPCnSigCorrected+3] = "TPC n_{#sigma}^{p} - corrected";
  fgVariableUnits[kTPCnSigCorrected+3] = "#sigma";
  ...
  fgVariableNames[kTOFmismatchProbability] = "TOF mismatch probab";
  fgVariableUnits[kTOFmismatchProbability] = "";
  ...
  fgVariableNames[kTRDntracklets]          = "Nof TRD tracklets";     fgVariableUnits[kTRDntracklets]    = "";
  fgVariableNames[kTRDntrackletsPID]       = "Nof TRD PID tracklets"; fgVariableUnits[kTRDntrackletsPID] = "";
  fgVariableNames[kTRDpidProbabilitiesLQ1D]   = "TRD LQ1D electron probability";
  fgVariableUnits[kTRDpidProbabilitiesLQ1D]   = "";
  fgVariableNames[kTRDpidProbabilitiesLQ1D+1] = "TRD LQ1D pion probability";
  fgVariableUnits[kTRDpidProbabilitiesLQ1D+1] = "";
  fgVariableNames[kTRDpidProbabilitiesLQ2D]   = "TRD LQ2D electron probability";
  fgVariableUnits[kTRDpidProbabilitiesLQ2D]   = "";
  fgVariableNames[kTRDpidProbabilitiesLQ2D+1] = "TRD LQ2D pion probability";
  fgVariableUnits[kTRDpidProbabilitiesLQ2D+1] = "";
  ...
  fgVariableNames[kEMCALmatchedEnergy]         = "Calo energy";
  fgVariableUnits[kEMCALmatchedEnergy]         = "GeV";
  fgVariableNames[kEMCALmatchedClusterId]      = "matched Calo cluster id";
  fgVariableUnits[kEMCALmatchedClusterId]      = "";
  ...
  fgVariableNames[kEMCALmatchedNMatchedTracks] = "Calo No. matched tracks";
  fgVariableUnits[kEMCALmatchedNMatchedTracks] = "";
  fgVariableNames[kEMCALmatchedDeltaPhi]       = "#Delta#varphi track-cluster";
  fgVariableUnits[kEMCALmatchedDeltaPhi]       = "";
  fgVariableNames[kEMCALmatchedDeltaEta]       = "#Delta#eta track-cluster";
  fgVariableUnits[kEMCALmatchedDeltaEta]       = "";
  fgVariableNames[kEMCALmatchedDistance]       = "track-cluster distance";
  fgVariableUnits[kEMCALmatchedDistance]       = "";
  fgVariableNames[kEMCALmatchedNSigmaElectron] = "EMCal n_{#sigma}^{e}";
  fgVariableUnits[kEMCALmatchedNSigmaElectron] = "#sigma";
  ...
  fgVariableNames[kEMCALnCells]         = "Cluster nof cells";      fgVariableUnits[kEMCALnCells]     = "";
  fgVariableNames[kEMCALnMatchedTracks] = "Cluster nof matched tracks";
  fgVariableUnits[kEMCALnMatchedTracks] = "";
  ...
  fgVariableNames[kTrackMCFlag]        = "Track MC flag";         fgVariableUnits[kTrackMCFlag]     = "";
  ...
  fgVariableNames[kTriggerPseudoProperDecayTime] = "t";
  fgVariableUnits[kTriggerPseudoProperDecayTime] = "cm/c";
  ...
  fgVariableNames[kAssociatedPtBoosted] = "p_{T} associated particle (boosted)";
  fgVariableUnits[kAssociatedPtBoosted] = "GeV/c";
  fgVariableNames[kAssociatedPtOverTriggerGammaT] = "p_{T} associated particle / #gamma_{T} trigger particle";
  fgVariableUnits[kAssociatedPtOverTriggerGammaT] = "GeV/c";
  ...
  fgVariableNames[kAssociatedEtaBoosted]  = "#eta associated particle";
  fgVariableUnits[kAssociatedEtaBoosted]  = "";
  fgVariableNames[kAssociatedPhi]         = "#varphi associated particle";
  fgVariableUnits[kAssociatedPhi]         = "rad";
  fgVariableNames[kAssociatedPhiBoosted]  = "#varphi associated particle";
  fgVariableUnits[kAssociatedPhiBoosted]  = "rad";
  ...
  fgVariableNames[kOneOverAssocHadronEff] = "1/#epsilon_{assoc}";
  fgVariableUnits[kOneOverAssocHadronEff] = "";
  fgVariableNames[kTriggerEffTimesAssocHadronEff] = "#epsilon_{trigger} #times #epsilon_{assoc}";
  fgVariableUnits[kTriggerEffTimesAssocHadronEff] = "";
  fgVariableNames[kOneOverTriggerEffTimesAssocHadronEff] = "1/#epsilon_{trigger} #times #epsilon_{assoc}";
  fgVariableUnits[kOneOverTriggerEffTimesAssocHadronEff] = "";
...
////////////////////////////////////////////////
  ...
  fgVariableNames[kJPsiPosPionOpeningAngle] = "OpAngle J#psi-#pi^{+}";
  fgVariableUnits[kJPsiPosPionOpeningAngle] = "rad";
  fgVariableNames[kJPsiNegPionOpeningAngle] = "OpAngle J#psi-#pi^{-}";
  fgVariableUnits[kJPsiNegPionOpeningAngle] = "rad";
  fgVariableNames[kPionsOpeningAngle]       = "OpAngle #pi^{+}-#pi^{+}";
  fgVariableUnits[kPionsOpeningAngle]       = "rad";
  fgVariableNames[kJPsiDiPionOpeningAngle]  = "OpAngle J#psi-#pi^{+}#pi^{-}";
  fgVariableUnits[kJPsiDiPionOpeningAngle]  = "rad";
...
//_________________________________________________________________
TChain* AliReducedVarManager::GetChain(const Char_t* filename, Int_t howMany, Int_t offset,
  Long64_t& entries, TChain* friendChain/*=0x0*/, const Char_t* friendDir/*=0x0*/,
...
//____________________________________________________________________________________
void AliReducedVarManager::SetGRPDataInfo(TH1I* dipolePolarity, TH1I* l3Polarity, TH1I* timeStart,
                                          TH1I* timeStop)
{
  //
...
void AliReducedVarManager::SetupGRPinformation(const Char_t* filename) {
  ...
  fgRunTotalLuminosity = (TH1F*)fgGRPfile->Get("lumiTotal")->Clone(
    "AliReducedVarManager_TotalLuminosity");
  fgRunTotalLuminosity->SetDirectory(0x0);
  fgRunTotalIntensity0 = (TH1F*)fgGRPfile->Get("intTotal0")->Clone(
    "AliReducedVarManager_TotalIntensity0");
  fgRunTotalIntensity0->SetDirectory(0x0);
  fgRunTotalIntensity1 = (TH1F*)fgGRPfile->Get("intTotal1")->Clone(
    "AliReducedVarManager_TotalIntensity1");
  fgRunTotalIntensity1->SetDirectory(0x0);
  fgRunLHCFillNumber = (TH1I*)fgGRPfile->Get("fillNumber")->Clone("AliReducedVarManager_LHCFillNumber");
  fgRunLHCFillNumber->SetDirectory(0x0);
  fgRunDipolePolarity = (TH1I*)fgGRPfile->Get("dipolePolarity")->Clone(
    "AliReducedVarManager_DipolePolarity");
  fgRunDipolePolarity->SetDirectory(0x0);
...
// type 1: for standard propagation, type 0 returns weight when setting leg PID efficiency to its 
//         value - 1 sigma,
// type 2: returns weight when setting leg PID efficiency to its value + 1 sigma
{
  ...
  Float_t legEffDown1  = TMath::Max(0., fgLegEfficiency->GetBinContent(binX1,binY1,binZ1) -
                                        fgLegEfficiency->GetBinError  (binX1,binY1,binZ1));
  Float_t legEff1      = fgLegEfficiency->GetBinContent(binX1, binY1, binZ1);
  Float_t legEffUp1    = TMath::Min(1., fgLegEfficiency->GetBinContent(binX1,binY1,binZ1) +
                                        fgLegEfficiency->GetBinError  (binX1,binY1,binZ1));
  Float_t legEffError1 = fgLegEfficiency->GetBinError(binX1, binY1, binZ1);


  Float_t legEffDown2  = TMath::Max(0., fgLegEfficiency->GetBinContent(binX2,binY2,binZ2)-
                                        fgLegEfficiency->GetBinError  (binX2,binY2,binZ2));
  Float_t legEff2      = fgLegEfficiency->GetBinContent(binX2, binY2, binZ2);
  Float_t legEffUp2    = TMath::Min(1., fgLegEfficiency->GetBinContent(binX2,binY2,binZ2) +
                                        fgLegEfficiency->GetBinError  (binX2,binY2,binZ2));
