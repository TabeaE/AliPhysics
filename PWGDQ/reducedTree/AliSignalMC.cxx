...
void AliSignalMC::SetSourceBit(UInt_t prong, UInt_t generation, UInt_t sourceBit, Bool_t exclude/*=kFALSE*/) {
  ...
  // NOTE: The exclude factor is set here via the inidividual source bit, but actually overrides the flag for all
  //       sources (in case multiple sources have been defined)
