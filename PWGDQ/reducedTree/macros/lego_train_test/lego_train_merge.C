void lego_train_merge(const char *dir, Int_t stage=0)
{
...
// Set temporary compilation directory to current one
   ...
   TString outputFiles = "LMEEoutput.root,EventStat_temp.root,dstTree.root";
   TString mergeExcludes = " EventStat_temp.root AliAOD.root";
   ...
   while((str=(TObjString*)iter->Next())) {
      ...
      merged = AliAnalysisAlien::MergeOutput(outputFile, outputDir, 500, stage);
      if (!merged) {
