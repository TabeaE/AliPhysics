...
if ! [ -f LMEEoutput.root ] ; then
   error=1
   echo "Output file LMEEoutput.root not found. Job FAILED !" >> stdout
   echo "Output file LMEEoutput.root not found. Job FAILED !" >> stderr
fi
...
if ! [ -f dstTree.root ] ; then
   error=1
   echo "Output file dstTree.root not found. Job FAILED !" >> stdout
   echo "Output file dstTree.root not found. Job FAILED !" >> stderr
fi
